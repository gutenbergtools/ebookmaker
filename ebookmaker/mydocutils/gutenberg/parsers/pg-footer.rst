...
.. |pg.copyrighted-footer| replace::

   This particular work is one of the few individual works protected
   by copyright law in the United States and most of the remainder of
   the world, included in the Project Gutenberg collection with the
   ...
   copyright holder on this work are set forth at the beginning of
   this work.

.. _pg_end_line:

\*\*\* END OF THIS PROJECT GUTENBERG EBOOK |pg.upcase-title| \*\*\*
...
This book can be found under: |pg.bibrec-url|
