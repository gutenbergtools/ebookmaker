...
Relocates static content from TemplateStrings.py to this file, for easier
maintenance and use by applications that need the license, header/footer,
CSS, etc. but not the functionality of HtmlTemplates.py
"""
...
headera = HEADERA.format(copyrighted='')
headera_copy = HEADERA.format(copyrighted=COPYRIGHTED)
headera_txt = re.sub(r'<[^>]+>', '', headera)
