...
at <a class="reference external" href="https://www.gutenberg.org">www.gutenberg.org</a>. If you are not located in the United States, you will have to check the laws of the country where you are located before using this eBook.
</div>
'''

headera_copy = headera + '''
<div style='display:block; margin:1em 0'>
...
def pgfooter(dc):
    pg_footerblock = f'{headerb_copy}' if 'copyright' in dc.rights else f'{headerb}'
